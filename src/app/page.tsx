...
export default function Home() {
  return (
    <main className="mx-auto my-auto flex max-w-5xl flex-col items-center justify-center text-matrix-neonGreen">
      <div className="mx-auto flex min-w-96! max-w-3xl flex-col gap-6 rounded-xl border-2 border-matrix-neonGreen/20 bg-matrix-digitalBlack/40 bg-gradient-to-br from-matrix-copper/20 via-matrix-digitalBlack/[0.15] to-matrix-black/50 p-6 shadow-[0_0_15px_rgba(0,255,0,0.07)] ring-1 ring-matrix-brightGreen/30 backdrop-blur-md sm:text-2xl">
