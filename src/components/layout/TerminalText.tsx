...
export function TerminalText() {
  const { displayText, cursorPosition, fullText, setDisplayText, setCursorPosition } = useTerminalStore();
  ...
  return (
    <div className="terminal-container relative min-w-full text-justify font-shareTech text-lg leading-relaxed">
      <pre className="w-full whitespace-pre-wrap font-shareTech">{displayText}</pre>
      <span
